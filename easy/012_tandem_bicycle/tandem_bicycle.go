...
So if person A pedals at a speed of 5, and person B pedals at a speed of 4, the tandem bicycle moves at a speed of 5
...
For example, if there are 4 riders (2 red-shirt riders and 2 blue-shirt riders)
